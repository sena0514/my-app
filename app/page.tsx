    ...
    <div className="mt-20">
      <div className="mx-auto max-w-3xl px-4">
        ...
        <div className="mt-12 grid justify-center gap-y-7 gap-x-5 grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
          ...
          <Link
            className="py-3 px-2  text-center rounded-lg border-4 border-gray-500 inline-block bg-red-300"
            href="/simpleMemo"
          >
            6.Simple Memo
          </Link>
          <Link
            className="py-3 px-2  text-center rounded-lg border-4 border-gray-500 inline-block bg-blue-300"
            href="/randomWords"
          >
            7.Random Words
          </Link>
          ...
          <Link
            className="py-3 px-2  text-center rounded-lg border-4 border-gray-500 inline-block bg-yellow-300"
            href="/countUpdate"
          >
            9.Count Update
          </Link>
